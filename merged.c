...
// Defines a node with left and right child
typedef struct Node {
    char data;
    struct Node *left, *right;
} Node;

// Points to the next node (used in Postfix_to_tree function)
...
// Main function: Handles command-line arguments and performs conversions
